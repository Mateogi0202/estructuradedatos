...
class Gerente(baseEmpleado): 
    ...
    def trabajar(self) -> str:
        return f"El gerente {self.nombre} está gestionando el equipo: {self.equipo}. y su sueldo"
...
mateo = desarrollador ("Mateo", "6.000.000", "Desarrollo", "Python")
Simon = Gerente ("Simón", "10.000.000", "Ventas", "2")
melina = Empleado ("Melina", "4.000.000", "Atención al cliente")
